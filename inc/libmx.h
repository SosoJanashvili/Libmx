...
void mx_swap_arr_elements(char **s1, char **s2);            // Not requested in challenge docs
...
char **mx_strsplit(char const *s, char c);                     // has to be completed
char *mx_strjoin(char const *s1, char const *s2);               // has to be completed
