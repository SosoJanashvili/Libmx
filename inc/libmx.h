...
char *mx_nbr_to_hex(unsigned long nbr);                                     //90
...
char *mx_strndup(const char *s1, size_t n);                                 //62  edited, +edited strncpy
char *mx_strcpy(char *dst, const char *src);                                //100
char *mx_strncpy(char *dst, const char *src, int len);                      //5    edited
